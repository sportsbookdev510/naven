(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
        ...
        return new Promise(function (r, i) {
          ...
          g(e, t, h, { once: !0 }),
            "error" !== t &&
              ...
              (o = a),
              (s = { once: !0 }),
              "function" == typeof n.on && g(n, "error", o, s));
        });
      }),
      (a.EventEmitter = a),
    ...
    Object.defineProperty(a, "defaultMaxListeners", {
      ...
      (a.prototype.emit = function (e) {
        ...
        if ("function" == typeof h) o(h, this, t);
        else
          for (var l = h.length, c = b(h, l), r = 0; r < l; ++r)
            o(c[r], this, t);
        return !0;
      }),
      ...
      (a.prototype.removeListener = function (e, t) {
        var r, i, n, o, s;
        if ((l(t), void 0 === (i = this._events) || void 0 === (r = i[e])))
          return this;
        if (r === t || r.listener === t)
          0 == --this._eventsCount
          ...
          for (; s; )
            try {
              if (
                ...
                return n;
              switch (((i = 0), n && (h = [2 & h[0], n.value]), h[0])) {
                case 0:
                case 1:
                  n = h;
                  break;
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let i = e.r(844501);
    i.__exportStar(e.r(644046), r), i.__exportStar(e.r(216043), r);
  },
  42593,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let i = e.r(844501);
    i.__exportStar(e.r(262676), r), i.__exportStar(e.r(42593), r);
  },
  128133,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 }),
      e.r(844501).__exportStar(e.r(339529), r);
  },
  401667,
  (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", { value: !0 });
    let i = e.r(844501);
    i.__exportStar(e.r(415978), r),
      i.__exportStar(e.r(128133), r),
      i.__exportStar(e.r(981056), r),
      i.__exportStar(e.r(627073), r);
  },
  355582,
  (e, t, r) => {
    "use strict";
  ...
  (e) => {
    ...
    function f(e) {
      return e
        ...
        ? new n(t.default.version.slice(1))
        : null;
    }
    function u(e) {
      var t =
      ...
      var u = f.join("."),
        ...
        p = h.exec(e);
      return p && p[1] ? new o(n, u, d, p[1]) : new i(n, u, d);
    }
    e.s(["detect", () => f], 757001);
    let d = (function (e) {
    ...
    class b extends Error {
      constructor(e) {
        super(e),
          Object.setPrototypeOf(this, Object.create(b.prototype)),
          ...
          return (function ({ sec: e, nsec: t }) {
            if (e >= 0 && t >= 0 && e <= 0x3ffffffff)
              if (0 === t && e <= 0xffffffff) {
                ...
                return (
                  n.setUint32(0, (t << 2) | (3 & r)), n.setUint32(4, 0 | e), i
                );
              }
            {
              let r = new Uint8Array(12),
                i = new DataView(r.buffer);
              return i.setUint32(0, t), g(i, 4, e), r;
            }
          })(
      ...
      decode: function (e) {
        let t = (function (e) {
          ...
          switch (e.byteLength) {
            ...
            case 12:
              return { sec: w(t, 4), nsec: t.getUint32(0) };
            default:
              throw new b(
    ...
    class v {
      ...
      decode(e, t, r) {
        ...
        return i ? i(e, t, r) : new y(t, e);
      }
    }
    v.defaultCodec = new v();
    ...
    let _ = "array",
      ...
      O = (e) => {
        ...
        throw new b("The type of key must be string or number but " + typeof e);
      };
    class B {
      constructor() {
      ...
      pushArrayState(e) {
        ...
        (t.type = _), (t.position = 0), (t.size = e), (t.array = Array(e));
      }
      pushMapState(e) {
        let t = this.getUninitializedStateFromPool();
    ...
    let T = new DataView(new ArrayBuffer(0)),
    ...
    class L {
      constructor(e) {
        (this.totalPos = 0),
          ...
          (this.stack = new B()),
          (this.entered = !1),
          (this.extensionCodec = e?.extensionCodec ?? v.defaultCodec),
          ...
          (this.keyDecoder = e?.keyDecoder !== void 0 ? e.keyDecoder : k),
          (this.mapKeyConverter = e?.mapKeyConverter ?? O);
      }
      clone() {
        return new L({
      ...
      *decodeMulti(e) {
      ...
      async decodeAsync(e) {
        ...
        try {
          ...
          throw RangeError(
            `Insufficient data in parsing ${p(
              i
            )} at ${o} (${n} in the current buffer)`
          );
        } finally {
          this.entered = !1;
        }
      ...
      doDecodeSync() {
        t: for (;;) {
          ...
          } else throw new b(`Unrecognized type byte: ${p(t)}`);
          this.complete();
          let r = this.stack;
          for (; r.length > 0; ) {
            let t = r.top();
            if (t.type === _)
              ...
              (t.key = this.mapKeyConverter(e)), (t.type = I);
              continue t;
            } else if (
      ...
      readArraySize() {
        ...
        switch (e) {
          ...
          default:
            ...
            throw new b(`Unrecognized array type byte: ${p(e)}`);
        }
      }
      pushMapState(e) {
        ...
        return (
          (r =
            this.stateIsMapKey() && this.keyDecoder?.canBeCached(e)
              ...
              : (function (e, t, r) {
                  let i;
                  if (!(r > 200)) return E(e, t, r);
                  return (i = e.subarray(t, t + r)), S.decode(i);
                })(this.bytes, i, e)),
          (this.pos += t + e),
          r
        );
      ...
      stateIsMapKey() {
        return this.stack.length > 0 && this.stack.top().type === U;
      }
      decodeBinary(e, t) {
    ...
    class R {
      ...
      encodeString(e) {
        ...
        this.ensureBufferSizeToWrite(5 + t),
          ...
          (function (e, t, r) {
            if (e.length > 50) x.encodeInto(e, t.subarray(r));
            else
              !(function (e, t, r) {
                let i = e.length,
                  n = r,
    ...
    function D(e, t) {
      return new R(t).encodeSharedRef(e);
    }
    e.s(["encode", () => D], 432266);
  },
  704192,
  ...
  (e) => {
    ...
    function u(e = 32) {
      ...
      if (h && "function" == typeof h.randomBytes) return h.randomBytes(e);
      ...
      digestInto(e) {
        ...
        (function (e, t, r, i) {
          ...
          let n = BigInt(32),
            ...
            h = 4 * !!i,
            l = 4 * !i;
          e.setUint32(t + h, s, i), e.setUint32(t + l, a, i);
        ...
        for (let e = 0; e < f; e++) h.setUint32(4 * e, u[e], n);
      }
      digest() {
    ...
    let p = BigInt(0x100000000 - 1),
      ...
      x = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r)),
      E = function (e, t, r, i) {
        let n = (t >>> 0) + (i >>> 0);
        return { h: (e + r + ((n / 0x100000000) | 0)) | 0, l: 0 | n };
      },
      S = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
      A = (e, t, r, i) => (t + r + i + ((e / 0x100000000) | 0)) | 0,
      _ = (e, t, r, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (i >>> 0),
      U = (e, t, r, i, n) => (t + r + i + n + ((e / 0x100000000) | 0)) | 0,
      I = (e, t, r, i, n, o) =>
      ...
      [B, T] = (function (e, t = !1) {
        ...
        for (let n = 0; n < e.length; n++) {
          let { h: o, l: s } = (function (e, t = !1) {
            return t
              ? { h: Number(e & p), l: Number((e >> y) & p) }
              : { h: 0 | Number((e >> y) & p), l: 0 | Number(e & p) };
          })(e[n], t);
          [r[n], i[n]] = [o, s];
        }
        return [r, i];
    ...
    class k extends d {
      ...
      get() {
        ...
        return [e, t, r, i, n, o, s, a, h, l, c, f, u, d, p, y];
      }
      set(e, t, r, i, n, o, s, a, h, l, c, f, u, d, p, y) {
        (this.Ah = 0 | e),
          (this.Al = 0 | t),
          (this.Bh = 0 | r),
          (this.Bl = 0 | i),
      ...
      process(e, t) {
        for (let r = 0; r < 16; r++, t += 4)
          (C[r] = e.getUint32(t)), (P[r] = e.getUint32((t += 4)));
        for (let e = 16; e < 80; e++) {
          let t = 0 | C[e - 15],
            r = 0 | P[e - 15],
            i = w(t, r, 1) ^ w(t, r, 8) ^ b(t, r, 7),
            n = m(t, r, 1) ^ m(t, r, 8) ^ g(t, r, 7),
            o = 0 | C[e - 2],
            s = 0 | P[e - 2],
            a = w(o, s, 19) ^ v(o, s, 61) ^ b(o, s, 6),
            h = _(
              n,
              m(o, s, 19) ^ x(o, s, 61) ^ g(o, s, 6),
              P[e - 7],
              P[e - 16]
            ),
            l = U(h, i, a, C[e - 7], C[e - 16]);
          (C[e] = 0 | l), (P[e] = 0 | h);
        }
        let {
          Ah: r,
        ...
        for (let e = 0; e < 80; e++) {
          let t = w(c, f, 14) ^ w(c, f, 18) ^ v(c, f, 41),
            b = m(c, f, 14) ^ m(c, f, 18) ^ x(c, f, 41),
            g = (c & u) ^ (~c & p),
            _ = O(L, b, (f & d) ^ (~f & y), T[e], P[e]),
            U = I(_, k, t, g, B[e], C[e]),
            N = 0 | _,
            R = w(r, i, 28) ^ v(r, i, 34) ^ v(r, i, 39),
            D = m(r, i, 28) ^ x(r, i, 34) ^ x(r, i, 39),
            M = (r & n) ^ (r & s) ^ (n & s),
            j = (i & o) ^ (i & a) ^ (o & a);
          (k = 0 | p),
            (L = 0 | y),
        ...
        ({ h: r, l: i } = E(0 | this.Ah, 0 | this.Al, 0 | r, 0 | i)),
          ({ h: n, l: o } = E(0 | this.Bh, 0 | this.Bl, 0 | n, 0 | o)),
          ({ h: s, l: a } = E(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | a)),
          ({ h: h, l: l } = E(0 | this.Dh, 0 | this.Dl, 0 | h, 0 | l)),
          ({ h: c, l: f } = E(0 | this.Eh, 0 | this.El, 0 | c, 0 | f)),
          ({ h: u, l: d } = E(0 | this.Fh, 0 | this.Fl, 0 | u, 0 | d)),
          ({ h: p, l: y } = E(0 | this.Gh, 0 | this.Gl, 0 | p, 0 | y)),
          ({ h: k, l: L } = E(0 | this.Hh, 0 | this.Hl, 0 | k, 0 | L)),
          this.set(r, i, n, o, s, a, h, l, c, f, u, d, p, y, k, L);
      }
      roundClean() {
        C.fill(0), P.fill(0);
      }
    ...
    let L =
        ((i = () => new k()),
        ((t = (e) => i().update(c(e)).digest()).outputLen = (r =
          i()).outputLen),
    ...
    function j(e) {
      if (!M(e)) throw Error("Uint8Array expected");
    }
    function z(e, t) {
    ...
    function V(e) {
      return j(e), H(W(Uint8Array.from(e).reverse()));
    }
    function q(e, t) {
    ...
    function Y(e, t, r) {
      ...
      else if (M(t)) i = Uint8Array.from(t);
    ...
    let Z = (e) => "bigint" == typeof e && N <= e;
    function X(e, t, r, i) {
      if (!(Z(t) && Z(r) && Z(i)) || !(r <= t) || !(t < i))
        throw Error(
    ...
    let Q = {
      ...
      stringOrUint8Array: (e) => "string" == typeof e || M(e),
      ...
      let a = Object.freeze({
        ...
        invertBatch: (e) => {
          ...
          return (
            (t = Array(e.length)),
            (r = e.reduce(
              (e, r, i) => (a.is0(r) ? e : ((t[i] = e), a.mul(e, r))),
              a.ONE
            )),
            (i = a.inv(r)),
            e.reduceRight(
              (e, r, i) =>
                a.is0(r) ? e : ((t[i] = a.mul(e, t[i])), a.mul(e, r)),
              i
            ),
            t
          );
    ...
    function em(e, t) {
      return (
        ew(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
      );
    }
    let ev = new WeakMap(),
      ex = new WeakMap();
    ...
    let eP = BigInt(5),
      ...
      eN = (function (e) {
        ...
        let r,
          ...
          y = i.adjustScalarBytes || ((e) => e),
          b =
            i.domain ||
            ((e, t, r) => {
              if ((z("phflag", r), t.length || r))
                throw Error("Contexts/pre-hash are not supported");
              return e;
            });
        function g(e, t) {
          X("coordinate " + e, t, eS, f);
        }
        function w(e) {
        ...
        let m = et((e, t) => {
            let { ex: r, ey: i, ez: o } = e,
              s = e.is0();
            null == t && (t = s ? eU : n.inv(o));
            let a = u(r * t),
              h = u(i * t),
              l = u(o * t);
            if (s) return { x: eS, y: eA };
            if (l !== eA) throw Error("invZ was invalid");
            return { x: a, y: h };
          }),
          v = et((e) => {
            let { a: t, d: r } = i;
        ...
        class x {
          ...
          static fromAffine(e) {
            ...
            let { x: t, y: r } = e || {};
            return g("x", t), g("y", r), new x(t, r, eA, u(t * r));
          }
          static normalizeZ(e) {
            ...
            return (function (e, t, r, i) {
              ...
              for (let e = l; e >= 0; e -= s) {
                ...
                for (let t = 0; t < i.length; t++) {
                  let n = Number((i[t] >> BigInt(e)) & BigInt(a));
                  h[n] = h[n].add(r[t]);
                }
                let t = n;
                for (let e = h.length - 1, r = n; e > 0; e--)
          ...
          double() {
            let { a: e } = i,
              ...
              b = u(f * p),
              g = u(c * p);
            return new x(y, b, u(d * f), g);
          }
          add(e) {
            w(e);
            let { a: t, d: r } = i,
              { ex: n, ey: o, ez: s, et: a } = this,
              { ex: h, ey: l, ez: c, et: f } = e;
            if (t === BigInt(-1)) {
              let e = u((o - n) * (l + h)),
                t = u((o + n) * (l - h)),
                r = u(t - e);
              if (r === eS) return this.double();
              let i = u(s * e_ * f),
                d = u(a * e_ * c),
                p = d + i,
                y = t + e,
            ...
            let d = u(n * h),
              ...
              A = u(v * E),
              _ = u(g * E);
            return new x(S, A, u(m * v), _);
          }
          subtract(e) {
            return this.add(e.negate());
          }
          wNAF(e) {
            return A.wNAFCached(this, e, x.normalizeZ);
          }
          multiply(e) {
            X("scalar", e, eA, o);
          ...
          multiplyUnsafe(e, t = x.ZERO) {
            return (
              ...
              e === eS
                ...
                : this.is0() || e === eA
                ? this
                : A.wNAFCachedUnsafe(this, e, x.normalizeZ, t)
            );
          }
          isSmallOrder() {
          ...
          isTorsionFree() {
            return A.unsafeLadder(this, o).is0();
          }
          toAffine(e) {
            return m(this, e);
          }
          clearCofactor() {
            let { h: e } = i;
            return e === eA ? this : this.multiplyUnsafe(e);
          }
          static fromHex(e, t = !1) {
            let { d: r, a: o } = i,
              s = n.BYTES;
            (e = Y("pointHex", e, s)), z("zip215", t);
            let a = e.slice(),
              h = e[s - 1];
            a[s - 1] = -129 & h;
            let l = V(a);
            X("pointHex.y", l, eS, t ? f : n.ORDER);
            let c = u(l * l),
              { isValid: d, value: y } = p(u(c - eA), u(r * c - o));
            if (!d) throw Error("Point.fromHex: invalid y coordinate");
            let b = (y & eA) === eA,
              g = (128 & h) != 0;
            if (!t && y === eS && g)
              throw Error("Point.fromHex: x=0 and x_0=1");
            return g !== b && (y = u(-y)), x.fromAffine({ x: y, y: l });
          }
          ...
          toRawBytes() {
            let { x: e, y: t } = this.toAffine(),
              r = J(t, n.BYTES);
            return (r[r.length - 1] |= e & eA ? 128 : 0), r;
          }
          toHex() {
            return W(this.toRawBytes());
          }
        }
        (x.BASE = new x(i.Gx, i.Gy, eA, u(i.Gx * i.Gy))),
          (x.ZERO = new x(eS, eA, eA, eS));
        let { BASE: E, ZERO: S } = x,
          A =
            ((t = 8 * l),
            {
              ...
              precomputeWindow(e, r) {
                let { windows: i, windowSize: n } = em(r, t),
                  o = [],
                  s = e,
                  a = s;
                for (let e = 0; e < i; e++) {
              ...
              wNAF(e, r, i) {
                let { windows: n, windowSize: o } = em(e, t),
                  s = x.ZERO,
                  a = x.BASE,
                  h = BigInt(2 ** e - 1),
                  l = 2 ** e,
                ...
                for (let e = 0; e < n; e++) {
                  let t = e * o,
                    n = Number(i & h);
                  (i >>= c), n > o && ((n -= l), (i += eb));
                  let f = t + Math.abs(n) - 1,
                    u = e % 2 != 0,
                    d = n < 0;
                  0 === n ? (a = a.add(eg(u, r[t]))) : (s = s.add(eg(d, r[f])));
                }
                return { p: s, f: a };
              },
              wNAFUnsafe(e, r, i, n = x.ZERO) {
                let { windows: o, windowSize: s } = em(e, t),
                  a = BigInt(2 ** e - 1),
                  h = 2 ** e,
                  l = BigInt(e);
                for (let e = 0; e < o; e++) {
                  ...
                  if (i === ey) break;
                  let o = Number(i & a);
                  if (((i >>= l), o > s && ((o -= h), (i += eb)), 0 === o))
                    continue;
                  let c = r[t + Math.abs(o) - 1];
                  o < 0 && (c = c.negate()), (n = n.add(c));
                }
                return n;
              },
        ...
        function _(e) {
          ...
          let r = Y("hashed private key", a(e), 2 * t),
            ...
            l = E.multiply(h),
            c = l.toRawBytes();
          return { head: i, prefix: s, scalar: h, point: l, pointBytes: c };
        }
        function U(e = new Uint8Array(), ...t) {
          return el(V(a(b(G(...t), Y("context", e), !!s))), o);
        }
        return (
          E._setWindowSize(8),
          {
            ...
            sign: function (e, t, r = {}) {
              ...
              let { prefix: i, scalar: a, pointBytes: h } = _(t),
                l = U(r.context, i, e),
                c = E.multiply(l).toRawBytes(),
                f = el(l + U(r.context, c, h, e) * a, o);
              return (
                X("signature.s", f, eS, o),
                Y("result", G(c, J(f, n.BYTES)), 2 * n.BYTES)
              );
            },
            verify: function (e, t, r, i = eI) {
              let o,
                a,
                h,
                { context: l, zip215: c } = i,
                f = n.BYTES;
              (e = Y("signature", e, 2 * f)),
                (t = Y("message", t)),
                (r = Y("publicKey", r, f)),
                void 0 !== c && z("zip215", c),
                s && (t = s(t));
              let u = V(e.slice(f, 2 * f));
              try {
                (o = x.fromHex(r, c)),
                  (a = x.fromHex(e.slice(0, f), c)),
                  (h = E.multiplyUnsafe(u));
              } catch {
                return !1;
              }
              if (!c && o.isSmallOrder()) return !1;
              let d = U(l, a.toRawBytes(), o.toRawBytes(), t);
              return a
        ...
        uvRatio: function (e, t) {
          ...
          let i,
            ...
            (y = (ec(p, s, eO) * d) % eO),
            (b = (ec(y, i, eO) * c) % eO),
            { pow_p_5_8: (ec(b, eC, eO) * r) % eO, b2: a }).pow_p_5_8,
            m = el(e * g * w, eO),
            v = el(t * m * m, eO),
            x = m,
            E = el(m * eB, eO),
    ...
    function eF(e = 0) {
      return null != globalThis.Buffer && null != globalThis.Buffer.allocUnsafe
        ? ez(globalThis.Buffer.allocUnsafe(e))
        : new Uint8Array(e);
    }
    function eW(e, t) {
      ...
      function f(e) {
        ...
        if (" " !== e[0]) {
          ...
          for (
            ...
            if (255 === c) return;
            for (var f = 0, u = o - 1; (0 !== c || f < n) && -1 !== u; u--, f++)
              (c += (a * s[u]) >>> 0),
                (s[u] = c % 256 >>> 0),
                (c = (c / 256) >>> 0);
          ...
          if (" " !== e[t]) {
            ...
            for (var p = new Uint8Array(i + (o - d)), y = i; d !== o; )
              p[y++] = s[d++];
            return p;
          }
        }
      ...
      return {
        encode: function (t) {
          ...
          for (var r = 0, i = 0, n = 0, o = t.length; n !== o && 0 === t[n]; )
            n++, r++;
          for (
            var s = ((o - n) * c + 1) >>> 0, l = new Uint8Array(s);
            n !== o;
          ...
          for (var y = h.repeat(r); p < s; ++p) y += e.charAt(l[p]);
          return y;
        },
        decodeUnsafe: f,
        decode: function (e) {
    ...
    let eG = ({ name: e, prefix: t, encode: r, decode: i }) =>
        new eY(e, t, r, i),
      eZ = ({ prefix: e, name: t, alphabet: r }) => {
        let { encode: i, decode: n } = eH(r, t);
        return eG({ prefix: e, name: t, encode: i, decode: (e) => e$(n(e)) });
      },
      eX = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
        eG({
          prefix: t,
          name: e,
          encode: (e) =>
    ...
    let tn = (e, t, r = 0) => (tr(e, t, r), t),
      to = (e, t) => {
        let r = t.byteLength,
          i = ti(e),
          n = i + ti(r),
          o = new Uint8Array(n + r);
        return tn(e, o, 0), tn(r, o, i), o.set(t, n), new ts(e, r, t, o);
      };
    class ts {
      constructor(e, t, r, i) {
    ...
    let ta = ({ name: e, code: t, encode: r }) => new th(e, t, r);
    class th {
      constructor(e, t, r) {
    ...
    let tp = td(
      ...
      ty = td(
        ...
        (e) => {
          let t = eF((e = e.substring(1)).length);
    ...
    function tw(e, t = "utf8") {
      ...
      return ("utf8" === t || "utf-8" === t) &&
        null != globalThis.Buffer &&
        null != globalThis.Buffer.from
        ? ez(globalThis.Buffer.from(e, "utf-8"))
        : r.decoder.decode(`${r.prefix}${e}`);
    }
    function tm(e) {
      return (0, o.safeJsonParse)(tg(tw(e, eR), eD));
    }
    function tv(e) {
      return tg(tw((0, o.safeJsonStringify)(e), eD), eR);
    }
    function tx(e) {
      return ["did:key", "z" + tg(eW([tw("K36", ej), e]), ej)].join(":");
    }
    function tE(e) {
      let t = e.split(".");
      return {
        ...
        payload: tm(t[1]),
        signature: tw(t[2], eR),
        data: tw(t.slice(0, 2).join("."), eM),
      };
    }
    function tS(e = u(32)) {
      let t = eN.getPublicKey(e);
      return { secretKey: eW([e, t]), publicKey: t };
    }
    async function tA(e, t, r, i, o = (0, n.fromMiliseconds)(Date.now())) {
      let s = { alg: "EdDSA", typ: "JWT" },
        a = { iss: tx(i.publicKey), sub: e, aud: t, iat: o, exp: o + r },
        h = tw(
      ...
      var l,
        c = {
          header: s,
          payload: a,
          signature: eN.sign(h, i.secretKey.slice(0, 32)),
        };
      return [tv(c.header), tv(c.payload), tg(c.signature, eR)].join(".");
    }
    e.s([
      "decodeJWT",
      () => tE,
  ...
  (e) => {
    ...
    function i(e, i) {
      i || (i = e.reduce((e, t) => e + t.length, 0));
      let n = r(i),
        o = 0;
      for (let t of e) n.set(t, o), (o += t.length);
      return t(n);
    }
    e.s(["concat", () => i], 855161);
    let n = function (e, t) {
      ...
      o = new Uint8Array(0),
      s = (e) => e.reduce((e, t) => e + t.toString(16).padStart(2, "0"), ""),
      a = (e) => {
        let t = e.match(/../g);
        return t ? new Uint8Array(t.map((e) => parseInt(e, 16))) : o;
      },
      h = (e, t) => {
        if (e === t) return !0;
      ...
      c = (e) => e instanceof ArrayBuffer || ArrayBuffer.isView(e),
      f = (e) => new TextEncoder().encode(e),
      u = (e) => new TextDecoder().decode(e);
    e.s(
      [
        "coerce",
        () => l,
    ...
    let w = ({ name: e, prefix: t, encode: r, decode: i }) => new g(e, t, r, i),
      m = ({ prefix: e, name: t, alphabet: r }) => {
        let { encode: i, decode: o } = n(r, t);
        return w({ prefix: e, name: t, encode: i, decode: (e) => l(o(e)) });
      },
      v = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
        w({
          prefix: t,
          name: e,
          encode: (e) =>
    ...
    e.s(["identity", 0, x], 327481);
    var E = e.i(327481);
    let S = v({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
    e.s(["base2", 0, S], 786817);
    var A = e.i(786817);
    let _ = v({
      prefix: "7",
      name: "base8",
    ...
    e.s(["base8", 0, _], 377726);
    var U = e.i(377726);
    let I = m({ prefix: "9", name: "base10", alphabet: "0123456789" });
    e.s(["base10", 0, I], 521227);
    var O = e.i(521227);
    let B = v({
        prefix: "f",
        name: "base16",
    ...
    e.s(["base16", 0, B, "base16upper", 0, T], 209553);
    var C = e.i(209553);
    let P = v({
        prefix: "b",
        name: "base32",
    ...
    e.s(["base36", 0, W, "base36upper", 0, H], 362570);
    var $ = e.i(362570);
    let K = m({
        name: "base58btc",
        prefix: "z",
    ...
    e.s(["base58btc", 0, K, "base58flickr", 0, V], 427879);
    var q = e.i(427879);
    let J = v({
        prefix: "m",
        name: "base64",
    ...
    let Q = Array.from(
      ...
      ee = Q.reduce((e, t, r) => ((e[r] = t), e), []),
      et = Q.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []),
      er = w({
        prefix: "🚀",
        name: "base256emoji",
        encode: function (e) {
    ...
    function eo(e, t) {
      ...
      return (eo.bytes = o - t), i;
    }
    let es = (e, t = 0) => [eo(e, t), eo.bytes],
      ea = (e, t, r = 0) => (en(e, t, r), t),
      eh = (e) => {
        var t;
        return (t = e) < 128
          ? 1
    ...
    e.s(["decode", 0, es, "encodeTo", 0, ea, "encodingLength", 0, eh], 508917);
    let el = (e, t) => {
        let r = t.byteLength,
          i = eh(e),
          n = i + eh(r),
          o = new Uint8Array(n + r);
        return ea(e, o, 0), ea(r, o, i), o.set(t, n), new eu(e, r, t, o);
      },
      ec = (e) => {
        let t = l(e),
          [r, i] = es(t),
          [n, o] = es(t.subarray(i)),
          s = t.subarray(i + o);
        if (s.byteLength !== n) throw Error("Incorrect length");
        return new eu(r, n, s, t);
      },
      ef = (e, t) =>
        e === t ||
        (e.code === t.code && e.size === t.size && h(e.bytes, t.bytes));
    class eu {
      constructor(e, t, r, i) {
        (this.code = e), (this.size = t), (this.digest = r), (this.bytes = i);
      }
    ...
    e.s(
      ["Digest", () => eu, "create", 0, el, "decode", 0, ec, "equals", 0, ef],
      7603
    );
    let ed = ({ name: e, code: t, encode: r }) => new ep(e, t, r);
    class ep {
      constructor(e, t, r) {
        (this.name = e), (this.code = t), (this.encode = r);
      }
      digest(e) {
        if (e instanceof Uint8Array) {
          ...
          return t instanceof Uint8Array
            ? el(this.code, t)
            : t.then((e) => el(this.code, e));
        }
        throw Error("Unknown type, must be binary type");
      }
    }
    e.s(["Hasher", () => ep, "from", 0, ed], 626974);
    let ey = (e) => async (t) =>
        new Uint8Array(await crypto.subtle.digest(e, t)),
      eb = ed({ name: "sha2-256", code: 18, encode: ey("SHA-256") }),
      eg = ed({ name: "sha2-512", code: 19, encode: ey("SHA-512") });
    e.s(["sha256", 0, eb, "sha512", 0, eg], 334130);
    var ew = e.i(334130);
    e.s(
      [
        "identity",
        0,
        { code: 0, name: "identity", encode: l, digest: (e) => el(0, l(e)) },
      ],
      919736
    );
    var em = e.i(919736);
    ...
    e.s(
      [
        ...
        "decode",
        0,
        (e) => JSON.parse(ex.decode(e)),
        "encode",
        0,
        (e) => ev.encode(JSON.stringify(e)),
        "name",
        0,
        "json",
      ],
    ...
    class eE {
      ...
      toString(e) {
        ...
        return 0 === r ? eA(t, i, e || K.encoder) : e_(t, i, e || P.encoder);
      }
      toJSON() {
        return {
          code: this.code,
      ...
      static isCID(e) {
        return eP(/^0\.0/, ek), !!(e && (e[eB] || e.asCID === e));
      }
      ...
      static create(e, t, r) {
        ...
        switch (e) {
          case 0:
            if (t === eU) return new eE(e, t, r, r.bytes);
            throw Error(
              `Version 0 CID must use dag-pb (code: ${eU}) block encoding`
            );
          case 1: {
            let i = eO(e, t, r.bytes);
    ...
    let eS = (e, t) => {
      ...
      eO = (e, t, r) => {
        ...
        return ea(e, o, 0), ea(t, o, i), o.set(r, n), o;
      },
      eB = Symbol.for("@ipld/js-cid/CID"),
      eT = { writable: !1, configurable: !1, enumerable: !0 },
      eC = { writable: !1, enumerable: !1, configurable: !1 },
      eP = (e, t) => {
...
`;
    e.i(508917), e.i(947898), e.i(626974), e.i(7603);
    let eL = { ...E, ...A, ...U, ...O, ...C, ...F, ...$, ...q, ...X, ...ei };
    function eN(e, t, r, i) {
      return {
        name: e,
        prefix: t,
    ...
    function ej(e, r = "utf8") {
      let i = eM[r];
      if (!i) throw Error(`Unsupported encoding "${r}"`);
    ...
    e.s(["fromString", () => ej], 230720),
      e.s(["toString", () => ez], 444838),
      e.s([], 894941);
    let eF = {
      waku: {
  ...
  (e, t, r) => {
    ...
    function u(e, t) {
      let r = 0;
      for (r = 0; r < 16; r++) (c[r] = e.h[r]), (c[r + 16] = h[r]);
      for (
        c[24] = c[24] ^ e.t,
    ...
    function p(e, t, r, i) {
      ...
      d.fill(0),
        ...
        r && d.set(r, 32),
        i && d.set(i, 48);
      for (let e = 0; e < 16; e++) n.h[e] = h[e] ^ s(d, 4 * e);
      return t && (y(n, t), (n.c = 128)), n;
    }
    function y(e, t) {
      for (let r = 0; r < t.length; r++)
        128 === e.c && ((e.t += e.c), u(e, !1), (e.c = 0)), (e.b[e.c++] = t[r]);
    }
    function b(e) {
  ...
  (e, t, r) => {
    ...
    function c(e, t) {
      let r = 0;
      for (r = 0; r < 8; r++) (h[r] = e.h[r]), (h[r + 8] = s[r]);
      for (
        h[12] ^= e.t, h[13] ^= e.t / 0x100000000, t && (h[14] = ~h[14]), r = 0;
        r < 16;
        r++
      ) {
        var i, o;
      ...
      for (r = 0; r < 10; r++)
        n(0, 4, 8, 12, l[a[16 * r + 0]], l[a[16 * r + 1]]),
          n(1, 5, 9, 13, l[a[16 * r + 2]], l[a[16 * r + 3]]),
          n(2, 6, 10, 14, l[a[16 * r + 4]], l[a[16 * r + 5]]),
          n(3, 7, 11, 15, l[a[16 * r + 6]], l[a[16 * r + 7]]),
          n(0, 5, 10, 15, l[a[16 * r + 8]], l[a[16 * r + 9]]),
          n(1, 6, 11, 12, l[a[16 * r + 10]], l[a[16 * r + 11]]),
          n(2, 7, 8, 13, l[a[16 * r + 12]], l[a[16 * r + 13]]),
          n(3, 4, 9, 14, l[a[16 * r + 14]], l[a[16 * r + 15]]);
    ...
    function f(e, t) {
      ...
      return (
        (i.h[0] ^= 0x1010000 ^ (r << 8) ^ e), r > 0 && (u(i, t), (i.c = 64)), i
      );
    }
    function u(e, t) {
      for (let r = 0; r < t.length; r++)
        64 === e.c && ((e.t += e.c), c(e, !1), (e.c = 0)), (e.b[e.c++] = t[r]);
    }
    function d(e) {
  ...
  (e, t, r) => {
    ...
    t.exports = function (e, t, r) {
      ...
      if (0 === h) return e;
      for (
        var l = "", c = 0, f = -1, u = (e && e.length) || 0, d = 0;
        d < u;
      ...
      return -1 === f ? e : (f < u && (l += e.slice(f)), l);
    };
  },
  288923,
  732078,
  ...
  (e) => {
    ...
    var r = e.i(246887),
      i = e.i(401667);
    class n {}
    e.s(["IEvents", () => n], 732078), e.s([], 17055);
    class o extends n {
      constructor(e) {
        super();
      }
    }
    let s = i.FIVE_SECONDS,
    ...
    class h extends o {
      ...
      async initialize() {
        this.intervalRef = setInterval(
          () => this.pulse(),
          (0, i.toMiliseconds)(this.interval)
        );
      }
      pulse() {
    ...
    e.s(["HEARTBEAT_EVENTS", () => a, "HeartBeat", () => h], 288923);
    var l = e.i(283450),
      c = e.i(594027);
    function f(e, ...t) {
      try {
    ...
    function b(e = {}) {
      let t,
        ...
        i = (e) => {
          ...
          return { base: "", relativeKey: e, driver: r.mounts[""] };
        },
        n = (e, t) =>
          r.mountpoints
        ...
        o = (e, t) => {
          if (r.watching) for (let i of ((t = p(t)), r.watchListeners)) i(e, t);
        },
        s = async () => {
          if (!r.watching)
            for (let e in ((r.watching = !0), r.mounts))
              r.unwatch[e] = await g(r.mounts[e], o, e);
        },
        a = async () => {
          if (r.watching) {
        ...
        m = {
          ...
          getItem(e, t = {}) {
            let { relativeKey: r, driver: n } = i((e = p(e)));
            return f(n.getItem, r, t).then((e) => (0, l.default)(e));
          },
          getItems: (e, t = {}) =>
            h(e, t, (e) =>
              e.driver.getItems
                ? f(
                    ...
                    t.map((t) => ({
                      ...
                      value: (0, l.default)(t.value),
                    }))
                  )
                : Promise.all(
                    e.items.map((t) =>
                      f(e.driver.getItem, t.relativeKey, t.options).then(
                        (e) => ({ key: t.key, value: (0, l.default)(e) })
                      )
                    )
                  )
            ),
          ...
          async setItem(e, t, r = {}) {
            ...
            let { relativeKey: n, driver: s } = i((e = p(e)));
            s.setItem &&
              (await f(s.setItem, n, u(t), r), s.watch || o("update", e));
          },
          async setItems(e, t) {
            await h(e, t, async (e) => {
              ...
              e.driver.setItem &&
                (await Promise.all(
                  e.items.map((t) =>
                    f(e.driver.setItem, t.relativeKey, u(t.value), t.options)
                  )
                ));
            });
          },
          async setItemRaw(e, t, r = {}) {
            if (void 0 === t) return m.removeItem(e, r);
            let { relativeKey: n, driver: s } = i((e = p(e)));
            if (s.setItemRaw) await f(s.setItemRaw, n, t, r);
            else {
              var a;
              if (!s.setItem) return;
              await f(
          ...
          async getMeta(e, t = {}) {
            ...
            if (
              (n.getMeta && Object.assign(o, await f(n.getMeta, r, t)),
              !t.nativeOnly)
            ) {
              let e = await f(n.getItem, r + "$", t).then((e) =>
                (0, l.default)(e)
              );
              e &&
                "object" == typeof e &&
          ...
          async getKeys(e, t = {}) {
            ...
            for (let e of r) {
              ...
              await f(e.driver.getKeys, e.relativeBase, t))) {
                let t = e.mountpoint + p(r);
          ...
          async clear(e, t = {}) {
            (e = y(e)),
              await Promise.all(
                n(e, !1).map(async (e) =>
                  e.driver.clear
                    ? f(e.driver.clear, e.relativeBase, t)
                    : e.driver.removeItem
                    ? Promise.all(
                        (
          ...
          async dispose() {
            await Promise.all(Object.values(r.mounts).map((e) => w(e)));
          },
          watch: async (e) => (
            await s(),
            r.watchListeners.push(e),
            async () => {
              (r.watchListeners = r.watchListeners.filter((t) => t !== e)),
                0 === r.watchListeners.length && (await a());
            }
          ),
          async unwatch() {
            (r.watchListeners = []), await a();
          },
          mount(e, t) {
            if ((e = y(e)) && r.mounts[e])
            ...
            return (
              e &&
                (r.mountpoints.push(e),
                r.mountpoints.sort((e, t) => t.length - e.length)),
              (r.mounts[e] = t),
              r.watching &&
                Promise.resolve(g(t, o, e))
                  .then((t) => {
                    r.unwatch[e] = t;
                  })
                  .catch(console.error),
          ...
          async unmount(e, t = !0) {
            (e = y(e)) &&
              ...
              (r.watching &&
                e in r.unwatch &&
                (r.unwatch[e]?.(), delete r.unwatch[e]),
              t && (await w(r.mounts[e])),
              (r.mountpoints = r.mountpoints.filter((t) => t !== e)),
              delete r.mounts[e]);
          },
          getMount(e = "") {
            let t = i((e = p(e) + ":"));
    ...
    function x() {
      return t || (t = v("keyval-store", "keyval")), t;
    }
    function E(e, t = x()) {
  ...
  (e) => {
    ...
    (h.prototype.getItem = function (e) {
      ...
      (h.prototype.setItem = function (e, t) {
        this[e] = String(t);
      }),
      (h.prototype.removeItem = function (e) {
        delete this[e];
      }),
    ...
    let c = async (e, t, r) => {
        ...
        for (; o.length; ) {
          ...
          if (
            ...
            await t.setItem(r, i), s.push(r);
          }
        }
        await t.setItem(i, 1), r(t), f(e, s);
      },
      f = async (e, t) => {
        t.length &&
          t.forEach(async (t) => {
  ...
  (e, t, r) => {
    ...
    function o() {
      return (
        void 0 !== i.default &&
        void 0 !== i.default.versions &&
        void 0 !== i.default.versions.node
      );
    }
    Object.defineProperty(r, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    Object.defineProperty(r, "__esModule", { value: !0 });
    let i = e.r(844501);
    i.__exportStar(e.r(346615), r), i.__exportStar(e.r(508735), r);
  },
  879374,
  (e, t, r) => {
    "use strict";
    ...
    (function (t) {
      ...
      function g(e, t) {
        ...
        if (
          ...
          (this.method =
            ((n = (i = t.method || this.method || "GET").toUpperCase()),
            b.indexOf(n) > -1 ? n : i)),
        ...
        return new Promise(function (o, s) {
          ...
          if (
            ...
            n &&
              ...
              !(
                n.headers instanceof c ||
                (r.Headers && n.headers instanceof r.Headers)
              ))
          ) {
            var d = [];
            Object.getOwnPropertyNames(n.headers).forEach(function (e) {
              d.push(a(e)), f.setRequestHeader(e, h(n.headers[e]));
            }),
          ...
          l.signal &&
            ...
            (f.onreadystatechange = function () {
              4 === f.readyState && l.signal.removeEventListener("abort", u);
            })),
      ...
      (x.polyfill = !0),
        r.fetch ||
          ((r.fetch = x), (r.Headers = c), (r.Request = g), (r.Response = m)),
        (t.Headers = c),
        (t.Request = g),
        (t.Response = m),
        (t.fetch = x),
  ...
  (e) => {
    ...
    function s(e) {
      return Object.keys(o).includes(e) ? o[e] : o[i];
    }
    function a(e, t, r) {
      ...
      return {
        ...
        error:
          ...
          void 0 === h
            ? s(r)
            : ("string" == typeof h &&
                (h = Object.assign(Object.assign({}, s(i)), { message: h })),
              void 0 !== l && (h.data = l),
              (c = h.code),
              n.includes(c) &&
                ((f = h.code),
                (h = (u = Object.values(o).find((e) => e.code === f)) || o[i])),
              h)),
      };
    }
    h.isNode,
    ...
    class B {
      ...
      async send(e) {
        ...
        try {
          this.socket.send((0, U.safeJsonStringify)(e));
        } catch (t) {
          this.onError(e.id, t);
        }
      }
      ...
      onPayload(e) {
        ...
        let t =
          "string" == typeof e.data ? (0, U.safeJsonParse)(e.data) : e.data;
        this.events.emit("payload", t);
      }
      onError(e, t) {
        let r = this.parseError(t),
          i = d(e, r.message || r.toString());
    ...
    var T = e.i(818735),
      ...
      D = (e, t, r) =>
        t in e
          ...
          : (e[t] = r),
      M = (e, t) => {
        for (var r in t || (t = {})) N.call(t, r) && D(e, r, t[r]);
        if (L) for (var r of L(t)) R.call(t, r) && D(e, r, t[r]);
        return e;
      };
    let j = {
      headers: {
    ...
    class z {
      ...
      async send(e) {
        ...
        try {
          let t,
            r,
            i = (0, U.safeJsonStringify)(e),
            n = await (
              await (0, T.default)(
                this.url,
                ((t = M({}, j)), (r = { body: i }), P(t, k(r)))
              )
            ).json();
    ...
    e.s(["HttpConnection", () => z, "default", () => z], 419462);
  },
]);
